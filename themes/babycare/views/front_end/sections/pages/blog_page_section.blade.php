...
@section('content')
    @include('front_end.sections.partision.header_section')
        ...
        <section class="blog-page-banner common-banner-section" style="background-image: url({{ get_file( $page_json->blog_page->section->image->image ?? 'themes/' .$currentTheme.'/assets/images/banner-inner.png')}});">
            <div class="container">
                <div class="row">
