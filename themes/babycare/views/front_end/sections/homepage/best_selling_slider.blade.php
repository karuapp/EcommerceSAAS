                        ...
                        <div class="best-selling-card-inner">
                            <div class="best-card-image">
                                <a href="{{ route('page.product-list', [$slug, 'main_category' => $cat->id]) }}"
                                    class="best-img">
                                    <img src="{{ get_file($cat->image_path,$currentTheme) }}" alt="bestproduct">
                                </a>
                                <div class="best-content">
                                    <div class="product-content-top">
                                        <div class="sub-title"> <span class="{{ $section->best_selling_slider->section->title->slug ?? '' }}_preview"> {{
                                            $section->best_selling_slider->section->title->text ?? __('CATEGORIES') }} </span> </div>
                                ...
                                <div class="best-card-btn">
                                    <a href="{{ route('page.product-list', [$slug, 'main_category' => $cat->id]) }}"
                                        ...
                                        <span class="{{ $section->best_selling_slider->section->button->slug ?? '' }}_preview"> {{
                                            $section->best_selling_slider->section->button->text ??  __('Go to categories') }}</span>
