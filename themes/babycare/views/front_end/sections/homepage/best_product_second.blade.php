        ...
        <div class="row">
                    ...
                    <div class="product-card">
                        <div class="product-card-inner">
                            ...
                            <div class="favorite-icon">
                                ...
                                {!! \App\Models\Product::actionLinks($currentTheme, $slug, $new_product) !!}
                            </div>
                            <div class="product-img">
                                <a href="#">
                                    <img src="{{ get_file($new_product->cover_image_path,$currentTheme) }}"
                                        alt="product-img">
                                </a>
                            </div>
                            <div class="product-content-bottom text-center">
                                <div class="price-label2">
                                    ...
                                    <div class="price">
                                    {!! \App\Models\Product::getProductPrice($new_product, $store, $currentTheme) !!}
                                    </div>
                                    @else
                                    <div class="price">
                                ...
                                <div class="product-card-btn-hook">
                                ...
                                {!! \App\Models\Product::ProductcardButton($currentTheme, $slug, $new_product) !!}
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-md-12 col-sm-12 col-lg-6 col-12">
                <div class="two-colum-img-card">
                    <img src="{{ get_file(
                    $section->best_product_second->section->image->image ?? '', $currentTheme) }}" class="products-card {{ $section->best_product_second->section->image->slug ?? '' }}_preview" alt="image">
