        ...
        <div class="row align-items-center row-gap">
            <div class="col-lg-5 col-md-5 col-12">
                <div class="shop-reviews-left-inner">
                    <div class="new-labl bg-second"  id="{{ $section->variant_background->section->sub_title->slug ?? '' }}_preview">
                    {!!
                        $section->variant_background->section->sub_title->text ?? '' !!}
                    </div>
                ...
                <div class="shop-reviews-right-inner">
                    ...
                    <div class="review-info-wrap">
                        <div class="review-box-wrapper">
                            ...
                            src="{{ get_file($section->variant_background->section->image->image ?? '', $currentTheme)}}" alt="user1">
                                            </li>
