<section class="padding-bottom today-discounts"
    ...
    <div class="container">
        <div class="section-title d-flex align-items-center justify-content-between">
            ...
            <a href="{{ route('page.product-list', ['storeSlug' => $slug]) }}" class="btn"
                    ...
                    <div class="product-card-inner">
                        <div class="product-card-image">
                            <a href="{{ url($slug . '/product/' . $item->slug) }}">
                                <img src="{{ get_file($item->cover_image_path, $currentTheme) }}" class="default-img">
                        ...
                        <div class="product-content">
                            ...
                            <div class="product-content-bottom">
                                @if ($item->variant_product == 0)
                                    <div class="price">
                                    {!! \App\Models\Product::getProductPrice ($item, $store, $currentTheme) !!}
                                    </div>
                                @else
                                    <div class="price">
