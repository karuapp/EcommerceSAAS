...
@section('content')
    ...
    @foreach ($blogs as $blog)
        <section class="blog-page-banner article-banner common-banner-section" style="background-image:url({{ get_file($page_json->article_page->section->image->image ?? 'themes/' . $currentTheme . '/assets/images/blog-banner.jpg', $currentTheme) }});">
        <div class="container">
                                ...
                                <div class="blog-widget col-md-12 col-sm-6 col-12">
                                    <div class="blog-widget-inner">
                                        <div class="blog-media">
                                            <span class="new-labl bg-second">{{ $data->category->name ?? __('Food') }}</span>
                                        ...
                                        <div class="blog-caption">
                                            ...
                                            <div class="blog-lbl-row d-flex align-items-center justify-content-between">
                                                ...
                                                <div class="author-info">
                                                    <strong class="auth-name">{{ $data->store->user->name ?? __('John Doe')}},</strong>
                            ...
                            <div class="blog-widget-inner">
                                ...
                                <div class="blog-caption">
                                    ...
                                    <div class="blog-lbl-row d-flex align-items-center justify-content-between">
                                        ...
                                        <div class="author-info">
                                            {{-- <strong class="auth-name">{{ $blog->store->user->name ?? __('John Doe,') }}</strong> --}}
