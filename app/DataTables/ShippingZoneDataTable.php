...
class ShippingZoneDataTable extends DataTable
{
    ...
    public function html(): HtmlBuilder
    {
        ...
        if (module_is_active('BulkDelete')) {
            $bulkdeleteButtonConfig = bulkDeleteForm('shipping-zone', 'shippingzone-table');
        }
