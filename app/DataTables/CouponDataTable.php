...
class CouponDataTable extends DataTable
{
    ...
    public function html(): HtmlBuilder
    {
        ...
        if (module_is_active('BulkDelete')) {
            $bulkdeleteButtonConfig = bulkDeleteForm('coupon','coupon-table');
        }
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('coupon_code')->title(__('Code')),
            Column::make('discount_amount')->title(__('Discount')),
            Column::make('coupon_limit')->title(__('Limit')),
            Column::make('coupon_expiry_date')->title(__('Expiry Date')),
