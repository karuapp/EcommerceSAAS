...
class RoleDataTable extends DataTable
{
    ...
    {
        return $model->newQuery()->with('permissions')->where('name', '!=', 'super admin')->where('created_by', '=', auth()->user()->creatorId());
    }
    ...
    public function html(): HtmlBuilder
    {
        ...
        if (module_is_active('BulkDelete')) {
            $bulkdeleteButtonConfig = bulkDeleteForm('roles','roles-table');
        }
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('permissions')->title(__('Permissions'))->orderable(false)->addClass('custom-yajra-label'),
