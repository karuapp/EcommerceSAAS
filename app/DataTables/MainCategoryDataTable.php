...
class MainCategoryDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        $dataTable = (new EloquentDataTable($query))
            ...
            ->editColumn('status', function ($maincategory) {
                if (!empty($maincategory->status)) {
            ...
            ->editColumn('image_path', function (MainCategory $maincategory) {
                if (!empty($maincategory->image_path)) {
                    $imagePath = get_file($maincategory->image_path, APP_THEME());
            ...
            ->editColumn('icon_path', function (MainCategory $maincategory) {
                if (!empty($maincategory->icon_path)) {
                    $iconPath = get_file($maincategory->icon_path, APP_THEME());
            ...
            ->rawColumns(['action','image_path','trending','status','icon_path']);
        return $dataTable;
    }
