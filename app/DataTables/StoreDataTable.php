...
class StoreDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->editColumn('avatar', function (User $user) {
                $avatarUrl = check_file($user->profile_image) ? get_file($user->profile_image, APP_THEME()) : get_file('storage/uploads/avatar.png');
    ...
    public function html(): HtmlBuilder
    {
        ...
        if (module_is_active('BulkDelete')) {
            $bulkdeleteButtonConfig = bulkDeleteForm('store','store-table');
        }
