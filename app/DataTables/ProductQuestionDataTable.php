...
class ProductQuestionDataTable extends DataTable
{
    ...
    public function html(): HtmlBuilder
    {
        $dataTable = $this->builder()
            ->setTableId('productquestion-table')
        ...
        if (module_is_active('BulkDelete')) {
            $bulkdeleteButtonConfig = bulkDeleteForm('product-question','productquestion-table');
        }
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('answers')->title(__('Status'))->addClass('text-capitalize'),
