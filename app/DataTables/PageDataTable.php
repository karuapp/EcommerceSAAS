...
class PageDataTable extends DataTable
{
    ...
    public function html(): HtmlBuilder
    {
        ...
        if (module_is_active('BulkDelete')) {
            $bulkdeleteButtonConfig = bulkDeleteForm('page','page-table');
        }
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('page_name')->title(__('Page Name')),
            Column::make('page_slug')->title(__('Page Slug')),
            Column::make('page_status')->title(__('Page Status'))->addClass('text-capitalize'),
