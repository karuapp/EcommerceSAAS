...
class ShippingMethodDataTable extends DataTable
{
    ...
    public function html(): HtmlBuilder
    {
        $dataTable = $this->builder()
            ->setTableId('shipping-taxmethod-table')
        ...
        if (module_is_active('BulkDelete')) {
            $bulkdeleteButtonConfig = bulkDeleteForm('shipping-taxmethod','shipping-taxmethod-table');
        }
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::computed('DT_RowIndex')
                ...
                ->orderable(false)
                ->searchable(false),
            Column::make('method_name')->title(__('Shipping Method')),
            Column::make('cost')->title(__('Shipping Cost')),
