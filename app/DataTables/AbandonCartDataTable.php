...
class AbandonCartDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
                ...
                ->addColumn('product', function (Cart $cart) {
                    $cart_count = Cart::where('customer_id',$cart->customer_id)->where('store_id', getCurrentStore())->where('theme_id', APP_THEME())->count();
    ...
    public function html(): HtmlBuilder
    {
        ...
        if (module_is_active('BulkDelete')) {
            $bulkdeleteButtonConfig = bulkDeleteForm('abandon-cart','abandoncart-table');
        }
