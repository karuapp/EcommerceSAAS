...
Route::group(['prefix' => 'install', 'as' => 'LaravelInstaller::', 'namespace' => 'RachidLaasri\LaravelInstaller\Controllers', 'middleware' => ['web', 'install','xss']], function () {
    Route::get('/', [
        'as' => 'welcome',
    ...
    Route::get('default_module/{module}', [
        'as' => 'default_module',
        'uses' => 'FinalController@default_module',
    ]);
    Route::get('default_module_active/{module_name?}', [
        'as' => 'default_module_active',
        'uses' => 'FinalController@default_module_active',
    ]);
