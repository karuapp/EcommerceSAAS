                                            ...
                                            <div class="row">
                                                    ...
                                                    <div class="card-body pt-0 text-center">
                                                        <div class=" setting-card">
                                                            ...
                                                            <div class="logo-content mt-4 d-flex justify-content-center">
                                                                    <img src="{{(!empty($userDetail->profile_image)) && file_exists($userDetail->profile_image) ? get_file($userDetail->profile_image , APP_THEME()) : $profile.'/avatar.png'}}"
                                                                    class=" rounded-circle-avatar" id="blah" width="100px">
                                                            </div>
                                                            <div class="choose-files mt-4">
                                                                <label for="file-1">
                                                                    ...
                                                                    <input type="file" class="form-control file" name="profile_image" id="file-1"
                                                                        data-filename="profile_update" onchange="document.getElementById('blah').src = window.URL.createObjectURL(this.files[0])">
                                                                </label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-lg-8 col-sm-6 col-md-6">
                                                    <div class="card-body pt-0">
                                                        ...
                                                        <div class="col-md-12">
                                                            {{Form::label('mobile',__('Mobile No.'),array('class'=>'col-form-label')) }}
                                                            {{Form::text('mobile',null,array('class'=>'form-control','placeholder'=>__('Enter User Mobile')))}}
                                                            @error('mobile')
