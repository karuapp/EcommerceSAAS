                    ...
                    <div class="product-info-top p-3 border-bottom">
                        <div class="row row-gap">
                            ...
                            <div class="col-sm-6 col-12">
                                {!! Form::label('', __('Category'), ['class' => 'form-label']) !!}<span
                                    class="text-danger">*</span>
                                {!! Form::select('maincategory_id', $MainCategory, null, [ 'class' =>
                            ...
                            <div class=" col-sm-6 col-12 subcategory_id_div" data_val='0'>
                                ...
                                <span>
                                    {!! Form::select('subcategory_id', $SubCategory, null, [ 'class' =>
                                        ...
                                        <div class="row gy-3 gx-3">
                                            ...
                                            <div class="col-sm-4 product_Image {{ 'delete_img_' . $file->id }}"
                                                ...
                                                <div
                                                    ...
                                                    <img src="{{ get_file($file->image_path, APP_THEME()) }}" alt=""
                                                        class="w-100">
                                                    <div
