                ...
                <div class="row align-items-start">
                    ...
                    <div class="col-lg-9 col-md-8 col-12">
                        <div class="my-acc-rightbar">
                                        ...
                                        <div class="row">
                                            ...
                                            <input type="hidden" name="type" value="{{auth('customers')->user()->type ?? 'customer'}}">
                                                <div class="form-group">
                                                    ...
                                                    <input name="old_password" value="{{ old('old_password') }}" type="password" class="form-control"
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input name="new_password" value="{{ old('new_password') }}" type="password" class="form-control"
                                                        placeholder="**********" required="">
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input name="new_password_confirmation" value="{{ old('new_password') }}" type="password"
                            ...
                            @include('front_end.hooks.my_account_tab_form')
                        </div>
                    </div>
                </div>
            </div>
