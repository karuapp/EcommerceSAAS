                    ...
                    <tbody>
                        @if (!empty($response->data->cart_total_product))
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="remove_item_from_cart" title="Remove item" data-id="{{ $item->cart_id }}" data-product-id = "{{ $item->product_id }}"  data-variant-id = "{{ $item->variant_id }}">
            ...
            <div class="cart-summery">
                <ul>
                    ...
                    <li>
                        ...
                        <span class="cart-sum-right coupon_discount_amount">{{ currency_format_with_sym((0) , $store->id, $currentTheme) ?? SetNumberFormat() }}</span>
                    </li>
                    @php
