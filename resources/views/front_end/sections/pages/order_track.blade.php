                        ...
                        <div class="card-body">
                            <div
                                ...
                                <div class="profile-pic bg-shade rounded">
                                    <img src="{{ !empty($customer->profile_image) ? get_file($customer->profile_image, $currentTheme) : get_file(Storage::url('uploads/customerprofile/avatar.png'), $currentTheme) }}"
