                ...
                <div class="category-card second-look">
                    @if ($key == '0')
                        <div class="category-img">
                            <img src="{{ asset($product->cover_image_path ?? 'themes/grocery/assets/images/menu-product.png') }}">
                        </div>
                    @else
                        <div class="category-img">
                            <img src="{{ asset($product->cover_image_path ?? 'themes/grocery/assets/images/donuts.png') }}">
                        </div>
                    @endif
                    <div class="category-card-body">
                        <div class="title-wrapper">
                            <div class="new-labl bg-second">
                                {{ ucfirst($product->ProductData->name ?? 'New') }}
                            </div>
                            <h2>{{ $product->name }}</h2>
                        </div>
