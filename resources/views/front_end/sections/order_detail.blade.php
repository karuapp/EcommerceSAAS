                                                    ...
                                                    @foreach ($order['product'] as $item)
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                @else
                                                                    {!! \App\Models\Product::ManageProductPrice($item, $store, $store->theme_id) !!}
                                                                @endif
                                                            </td>
                                                            @if ($order['order_status'] == 1 && $order['is_guest'] == 0)
                                                                <td> - </td>
                                            ...
                                            <table class="table">
                                                <tbody>
                                                    ...
                                                    @if ($order['paymnet_type'] == 'POS')
                                                        <tr>
                                                            <td>{{ __('Discount') }} :</td>
                                                            <td>{{ !empty($order['coupon_price']) ? currency_format_with_sym($order['coupon_price'] ?? 0, $store->id, $store->theme_id) ?? SetNumberFormat($order['coupon_price']) : SetNumberFormat(0) }}
                                                            </td>
                                                        </tr>
                                                    @else
                                                        <tr>
