<div class="container">
    <div class="blog-grid-title d-flex justify-content-between align-items-center ">
        <div class="section-title">
            <span class="sub-title">{{ $page_json->article_page->section->section_title->text ?? __('All Products') }}</span>
            <h3>{!!$page_json->article_page->section->section_sub_title->text ?? __('From  our blog') !!}</h3>
        </div>
        <a href="{{route('page.blog',$slug)}}" class="btn">{{ $page_json->article_page->section->section_sub_button->text ??__('Read More') }}</a>
    </div>
                                ...
                                <div class="blog-card-inner">
                                    ...
                                    <div class="blog-card-content">
                                        ...
                                        <div class="blog-card-bottom">
                                            ...
                                            {{ $page_json->article_page->section->section_sub_button->text ??__('Read More') }}
