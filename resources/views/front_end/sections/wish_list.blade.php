            ...
            @foreach ($wishlists as $wishlist)
                ...
                <tr>
                    <td data-label="Product">
                        <a href="{{route('page.product',[$slug,$wishlist->ProductData->slug])}}">
                    ...
                    <td data-label="Action">
                        ...
                        <i class="ti ti-trash text-white py-1 delete_wishlist" data-id="{{ $wishlist->id }}" data-bs-toggle="tooltip" title="delete"></i> </a>
                    </td>
                </tr>
            @endforeach
        @else
            <tr>
                <td colspan="6"><h2>{{ __('No records found')}}</h2></td>
            </tr>
        @endif
    </tbody>
</table>
@if(isset($wishlists) && $wishlists->total() > 10)
